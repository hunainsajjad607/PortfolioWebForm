<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PortfolioWebForm.aspx.vb" Inherits="PortfolioWebForm.PortfolioWebForm" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                    <div class="about-thumb">
                        ...
                        <h3 class="pt-2 mb-3">a little bit about Hunain</h3>
                    ...
                    <div class="profile-thumb">
                        ...
                        <div class="profile-body">
                            <p>
                                ...
                                <span>Hunain Sajjad</span>
                            </p>

                            <p>
                                <span class="profile-small-title">Birthday</span> 
                                <span>Dec 22, 1997</span>
                            </p>

                            <p>
                                <span class="profile-small-title">Phone</span> 
                                 <span><a href="tel: 305-240-9671">+92-316-5888508</a></span>
                            </p>

                            <p>
                                <span class="profile-small-title">Email</span> 
                                <span><a href="mailto:hello@josh.design">hunain.sajjad.607.hs@gmail.com</a></span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 ps-lg-0">
                        <div class="contact-info d-flex flex-column">
                            ...
                            <p class="mb-2">
                                Hunain is a professional web developer. Feel free to get in touch with me.
                      </p>
                            ...
                            <p>
                                <a href="mailto:hello@josh.design">
                                    hunain.sajjad.607.hs@gmail.com
                                </a>
                            </p>
